    ...
    <>
      ...
      rgba(6, 6, 10, 0.5)
                ...
                >
                  ...
                  <h2 className="display-6 text-warning">${items.price}</h2>
                  <div className="d-flex flex-column text-start">
                    <div className="my-3 d-flex align-items-cente justify-content-center">
                      <CheckAll />
                    ...
                    <div className="my-3 d-flex justify-content-center">
                      <button className="py-2 w-50 px-3 text-uppercase primary-btn">
                        Purchase
                      </button>
                    </div>
                  </div>
